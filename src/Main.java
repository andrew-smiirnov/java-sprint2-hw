/* Привет! На сколько я понял необходимо проверить работу всех методов в менеджерах, но не обязательно проверять
* все строки в них на 100%?! К тому же некоторые из методов используются как вспомогательные и задействованы при
* работе других методов.
*/
